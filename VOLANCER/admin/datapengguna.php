...
<nav class="navbar navbar-expand-md navbar-light bg-warning">
  ...
  <div class="row" id="body-row">
      ...
      <div class="col">
      <h3>Data pengguna yang terdaftar</h3><br>
       <!-- Navbar Search-->
       <form action="datapengguna.php" method="get" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <div class="input-group">
                    <input class="form-control" type="text" name="cari" placeholder="Cari username..." aria-label="Search" aria-describedby="basic-addon2" />
      ...
      <table class="table table-bordered">
        ...
        if(isset($_GET['cari'])){
            $cari = $_GET['cari'];
            $data = mysqli_query($connect,"select * from tb_user where username like '%".$cari."%'");
        }else{
